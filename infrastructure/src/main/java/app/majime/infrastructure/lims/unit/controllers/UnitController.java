package app.majime.infrastructure.lims.unit.controllers;
...
import app.majime.infrastructure.lims.parameter.repositories.ParameterRepository;
import app.majime.infrastructure.lims.unit.repositories.UnitRepository;
...
public class UnitController {
    ...
    public ResponseEntity<Unit> addNewUnit(@RequestBody Unit newUnit){
        Optional<Unit> unitFromDb = repository.findByName(newUnit.getName());
