...
create table user (id int8 not null, batch_id int4 not null, email varchar(255), first_name varchar(255), last_name varchar(255), login varchar(255), password varchar(255), phone varchar(255), status int4 not null, primary key (id))
alter table if exists sample add constraint FKeugkgqdrooa9puw83rae7pu6b foreign key (user_id) references user
